...
async function main() {
    ...
    console.log(nonce, '===nonce--', await starknetHelp.account.getNonce());
    ...
    //     nonce
    // });
    console.log('===result', await starknetHelp.account.getNonce(), '===');
    const res = await starknetHelp.transfer("0x03e85bfbb8e2a42b7bead9e88e9a1b19dbccf661471061807292120462396ec9", "0x050e5ba067562e87b47d87542159e16a627e85b00de331a53b471cee1a4e5a4f")

    // const res = await starknetHelp.sendEthTransaction("0x03e85bfbb8e2a42b7bead9e88e9a1b19dbccf661471061807292120462396ec9", "0x050e5ba067562e87b47d87542159e16a627e85b00de331a53b471cee1a4e5a4f", "1");
    console.log(res);
