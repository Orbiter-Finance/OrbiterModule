<template>
  <vxe-toolbar>
    <template #buttons>
      <div
        ...
        "
      >
        <vxe-button style="margin-left: 10px" @click="insertEvent()"
          >add</vxe-button
        >
        <vxe-button
          style="margin-right: 10px"
          @click="authInfo.showAuth = true"
          >{{ s3Proof ? 'authed' : 'auth' }}</vxe-button
        >
      </div>
    </template>
  </vxe-toolbar>
  ...
  >
    ...
    <vxe-column
      field="c1AvalibleDeposit"
      title="c1AvalibleDeposit"
      width="150"
    ></vxe-column>
    <vxe-column
      field="c2AvalibleDeposit"
      title="c2AvalibleDeposit"
      width="150"
    ></vxe-column>
    <vxe-column
      field="c1TradingFee"
    ...
    <vxe-colgroup title="c1AvalibleTimes">
      <vxe-column
        field="c1AvalibleTimes[0].startTime"
        title="startTime"
        :formatter="formatterDate"
        width="150"
      ></vxe-column>
      <vxe-column
        field="c1AvalibleTimes[0].endTime"
        title="endTime"
        :formatter="formatterDate"
        width="80"
      ></vxe-column>
    ...
    <vxe-colgroup field="c2AvalibleTimes" title="c2AvalibleTimes">
      <vxe-column
        field="c2AvalibleTimes[0].startTime"
        :formatter="formatterDate"
        title="startTime"
        width="150"
      ></vxe-column>
      ...
      <vxe-column
        field="c2AvalibleTimes[0].endTime"
        title="endTime"
        :formatter="formatterDate"
        width="80"
      ></vxe-column>
  ...
  <div style="margin: 15px 0 5px 0">
    ...
    <vxe-table
      ...
      :scroll-x="{ gt: 10 }"
      :column-config="{ resizable: true }"
      :data="tradeInfo.historyTableData"
    >
      <vxe-column
        field="makerAddress"
        title="makerAddress"
  ...
  >
    <template #default>
      <vxe-form
        :data="tradeInfo.formData"
        :rules="tradeInfo.formRules"
        title-align="left"
        title-width="100"
        @submit="submitEvent"
      >
        ...
        >
          <template #default="{ data }">
            <vxe-input
              v-model="data.makerAddress"
              placeholder="input makerAddress"
            ></vxe-input>
          </template>
        </vxe-form-item>
        ...
        <vxe-form-item field="c1ID" title="c1ID" :span="12">
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="integer"
              v-model="data.c1ID"
              placeholder="input c1ID"
            ></vxe-input>
          </template>
        </vxe-form-item>
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              v-model="data.t1Address"
              placeholder="input t1Address"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              v-model="data.t2Address"
              placeholder="input t2Address"
            ></vxe-input>
          </template>
        </vxe-form-item>
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="number"
              v-model="data.c1MinPrice"
              placeholder="input c1MinPrice"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="number"
              v-model="data.c1MaxPrice"
              placeholder="input c1MaxPrice"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="number"
              v-model="data.c2MinPrice"
              placeholder="input c2MinPrice"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="number"
              v-model="data.c2MaxPrice"
              placeholder="input c2MaxPrice"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="number"
              v-model="data.c1AvalibleDeposit"
              placeholder="input c1AvalibleDeposit"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              :disabled="tradeInfo.selectRow ? true : false"
              type="number"
              v-model="data.c2AvalibleDeposit"
              placeholder="input c2AvalibleDeposit"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              type="number"
              v-model="data.c1TradingFee"
              placeholder="input c1TradingFee"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              type="number"
              v-model="data.c2TradingFee"
              placeholder="input c2TradingFee"
            ></vxe-input>
          </template>
        </vxe-form-item>
        ...
        >
          <template #default="{ data }">
            <vxe-input
              type="number"
              v-model="data.c1GasFee"
              placeholder="input c1GasFee"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item
        ...
        >
          <template #default="{ data }">
            <vxe-input
              type="number"
              v-model="data.c2GasFee"
              placeholder="input c2GasFee"
            ></vxe-input>
          </template>
        </vxe-form-item>
    ...
    <template #default>
      ...
      >
        ...
        >
          <template #default="{ data }">
            <vxe-input
              v-model="data.s3Proof"
              placeholder="input s3Proof"
            ></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item align="center" title-align="left" :span="24">
  ...
  setup() {
    ...
    const tradeInfo = reactive({
      ...
      formRules: {
        ...
        c1ID: [{ required: true, message: 'input c1ID' }, { min: 1 }],
        c2ID: [{ required: true, message: 'input c2ID' }, { min: 1 }],
        c1Name: [
        ...
        precision: [{ required: true, message: 'input precision' }, { min: 1 }],
        c1AvalibleDeposit: [
        ...
        c1GasFee: [{ required: true, message: 'input c1GasFee' }, { min: 1 }],
        c2GasFee: [{ required: true, message: 'input c2GasFee' }, { min: 1 }],
        c1StartTime: [
    ...
    const editEvent = (row: any) => {
      ...
      tradeInfo.formData = {
        ...
        c1StartTime: dayjs
          .unix(row.c1AvalibleTimes[0].startTime)
          .format('YYYY-MM-DD HH:mm:ss'),
        c2StartTime: dayjs
          .unix(row.c2AvalibleTimes[0].startTime)
          .format('YYYY-MM-DD HH:mm:ss'),
      }
    ...
    const removeEvent = async (row: any) => {
      ...
      if (type === 'confirm') {
        try {
          ...
          const oldHistoryMakerList = JSON.parse(
            JSON.stringify(historyMakerList, null, '')
          )
          const oldDataObj = {
          ...
          theOldMaker[0].c1AvalibleTimes[0].endTime =
            Date.parse(new Date().toString()) / 1000
          theOldMaker[0].c2AvalibleTimes[0].endTime =
            Date.parse(new Date().toString()) / 1000
    ...
    const submitEvent = async () => {
      ...
      if (
        ...
        !formData.c2MaxPrice ||
        !formData.precision ||
        !formData.c1AvalibleDeposit ||
        !formData.c2AvalibleDeposit ||
        !formData.c1TradingFee ||
        !formData.c2TradingFee ||
        !formData.c1GasFee ||
        !formData.c2GasFee! ||
        !formData.c1StartTime ||
        !formData.c2StartTime
      ) {
        return
      }
      try {
