...
function isAmountInRegion(amount, chain) {
  ...
  logger.log('amountRegion_min', amountRegion.min.toString())
  logger.log('amountRegion_max', amountRegion.max.toString())
  if (
